...
1. Install the Bito CLI through MSI using this [installer](https://github.com/gitbito/CLI/blob/main/version-3.7/Bito%20CLI.exe).
...
1. Download Bito CLI binary specific to your OS platform from [here](https://github.com/gitbito/CLI/tree/main/version-3.7) (Please download the latest version for all new updates).
