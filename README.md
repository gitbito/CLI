...
1. Install the Bito CLI through MSI using this [installer](https://github.com/gitbito/CLI/blob/main/version-4.2/Bito%20CLI.exe).
...
1. Download Bito CLI binary specific to your OS platform from [here](https://github.com/gitbito/CLI/tree/main/version-4.2) (Please download the latest version for all new updates).
